...
public class MapIntroduction02 {
    ...
    public static void main(String[] args) {
        ...
        map.values().removeIf(value -> value.contains("Lupus"));

        map.put("978-1-60309-450-4", "They Called Us Enemy");
        map.put("978-1-60309-453-5", "Why Did We Trust Him?");


        if (map.containsKey("78-0-61159-424-8")) {
            System.out.println(map.get("78-0-61159-424-8"));
        } else System.out.println("There is no key like this!");


        if (map.containsKey("978-1-60309-453-5")) {
